        ...
        <form action="<?= _page("payment"); ?>" method="post" id="frm_selectpaymentmethod" class="mobile-info-pax mobile-margin-left-right-15">
            ...
            <div class="methods clearfix">
                <div class="methods-header transfer">
                     <label for="method_transfer" class="methods-header active"><input checked="checked" type="radio" id="method_transfer" name="radio" />
                     <span>Chuyển khoản</span>
                        <p>Đây là hình thức thanh toán tối ưu nhất và không mất phí. Quý khách có thể chọn lựa tài khoản ngân hàng chuyển đến cùng hệ thống với cái đang sử dụng nhằm đảm bảo tiền được chuyển sang nhanh.</p>
					</label>
                </div>
                <div class="methods-content clearfix" id="content_transfer" style="display: block;">
                    <p style="padding-left: 10px;" class="mobile-mothods-content-first">
                        ...
                        Cú pháp tin nhắn:<br>
                        <b>"Mã đơn hàng, Người liên hệ, Nội dung thanh toán"</b><br/>

                        Ví dụ:<br/>
                        <em>"V4AHC78H54, Nguyen Van An, TT vé máy bay "</em><br/>
                        <em>"V4AHF78H53, Nguyen Van Minh, TT vé máy bay "</em><br/>
                        <em>"V4AHK78H52, Nguyen Van Duong, TT vé máy bay "</em><br/>
                    </p>

                    <p><button type="submit" name="sm_transfer_method"  class="button redcus pull-right mb30"  > <span class="pull-left">Đặt vé </span><i class="fa fa-angle-right box-icon-border box-icon-right round box-icon-white box-icon-small"></i></button>
            ...
            <div class="methods clearfix">
                <div class="methods-header office">
                    <label for="method_office" class="methods-header"><input type="radio" id="method_office" name="radio" />
                   
                       <span> Tại văn phòng</span> 
                        <p>Sau khi đặt hàng thành công, quý khách có thể đến văn phòng ở địa chỉ <strong><?php echo ot_get_option('company_address'); ?></strong> để thanh toán và nhận vé.</p>
                    </label>
                </div>
                <div class="methods-content" id="content_office">
                    ...
                    <div class="clearfix"></div>
                   	 ...
                   	 <p><button type="submit"name="sm_office_method" class="button redcus  pull-right mb30"  ><span class="pull-left"> Đặt vé </span><i class="fa fa-angle-right box-icon-border box-icon-right round box-icon-white box-icon-small"></i></button>
					</p>
                </div>
            </div><!--.methods-->
            ...
            <div class="methods clearfix">
                <div class="methods-header home">
                    <label for="method_athome" class="methods-header"> <input type="radio" id="method_athome" name="radio" />
